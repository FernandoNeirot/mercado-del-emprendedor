...
export function VendorCardLarge({
  ...
  return (
    <div className="bg-gray-100 dark:bg-card-dark rounded-2xl md:rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all group border border-slate-100 dark:border-slate-800 p-3">
        ...
        <div className="md:w-3/5 p-3 md:p-4 flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-2 md:gap-3">
            ...
            <button
              ...
              className="w-full py-2 shadow-sm md:py-2.5 bg-slate-200 dark:bg-slate-600 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg md:rounded-xl font-bold flex items-center justify-center gap-2 transition-all border border-slate-100 dark:border-slate-700 uppercase text-[10px] md:text-xs tracking-wider"
            >
              <Icon name="call" className="text-xs md:text-sm" />
              Contactar
            </button>
          </div>
        </div>

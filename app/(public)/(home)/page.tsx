...
export default function Home() {
  return (
    <div className="relative flex min-h-screen w-full flex-col md:max-w-310 mx-auto bg-soft-bg dark:bg-background-dark overflow-x-hidden shadow-2xl md:shadow-none pb-24 md:pb-0">
      <Header />
      <main className="flex-1 w-full md:max-w-310 md:mx-auto md:px-6 lg:px-8 md:py-8">
